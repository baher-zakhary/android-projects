...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new ListItem("father", "әpә", R.drawable.family_father, R.raw.family_father));
        words.add(new ListItem("mother", "әṭa", R.drawable.family_mother, R.raw.family_mother));
        words.add(new ListItem("son", "angsi", R.drawable.family_son, R.raw.family_son));
        words.add(new ListItem("daughter", "tune", R.drawable.family_daughter, R.raw.family_daughter));
        ...
        ListItemAdapter adapter = new ListItemAdapter(this, words, R.color.category_family);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(FamilyActivity.this, ListItem.audioTrackId);
